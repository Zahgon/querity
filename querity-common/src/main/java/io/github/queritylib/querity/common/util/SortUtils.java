...
public class SortUtils {
    ...
    private static <T> Optional<Class<? extends T>> findClassWithNativeSortWrapperConstructor(Set<Class<? extends T>> allClasses, Class<?> wrappedType) {
        return allClasses.stream().filter(clazz -> hasNativeSortWrapperConstructorForType(clazz, wrappedType)).findAny();
    }
